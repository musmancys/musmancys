...
| 🐍 **Snake Game** | Terminal Snake built on the curses module | Python |
...
```bash
[2026-06-27 → 2026-07-27]  DecodeLabs        Cybersecurity Intern
                           > encryption, phishing analysis, vulnerability assessment
[ ongoing / done ]         CodeAlpha          Python Programming Intern
                           > Hangman, Stock Portfolio Tracker, Task Automation, Chatbot
